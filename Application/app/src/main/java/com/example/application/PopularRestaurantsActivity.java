...
public class PopularRestaurantsActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "PopularRActivity";
    ListView listView;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.yeelightButton:
                ...
                Intent intent = new Intent(PopularRestaurantsActivity.this, MyRestaurantsActivity.class);
                Cursor data = mDatabaseHelper.getData();
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("[");
                while (data.moveToNext()) {
                ...
                break;
            case R.id.fab:
                print("Clicked yeelightButton");
                Intent intent2 = new Intent(PopularRestaurantsActivity.this, MainActivity.class);
